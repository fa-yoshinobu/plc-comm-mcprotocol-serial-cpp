@echo off
setlocal
set "DOCS_OUTPUT_DIR=%TEMP%\plc-docs\plc-comm-mcprotocol-serial-cpp"
set "TEMP_DOXYFILE=.tmp_doxyfile"

echo ===================================================
echo [DOCS] Generating MC Protocol Serial C++ Documentation...
...
if %errorlevel% equ 0 (
    ...
    echo [SUCCESS] Documentation generated at: %DOCS_OUTPUT_DIR%/api/index.html
    exit /b 0
) else (
    del /q %TEMP_DOXYFILE% >nul 2>&1
