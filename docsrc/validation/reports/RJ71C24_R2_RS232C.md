...
| `28800 / 8E2 / Format1 ASCII / sum-check on / station 0 / --series ql` | `cpu-model`, `loopback`, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper `0601/1601` | pass |
...
| Format1 ASCII practical path | pass | `R120PCPU / 28800 / 8E2 / sum-check on / station 0`; `cpu-model`, `loopback`, `write-words D10=1 -> read-words D10 1 -> restore`, `write-host-buffer 2 1 -> read-host-buffer 2 1 -> restore`, and `write-qualified-words U3E0\\G0 0x1234 -> read-qualified-words U3E0\\G0 1 -> restore` passed |
| Format1 ASCII native family | target-dependent / not practical | on the current `RJ71C24-R2 + R120PCPU` setup, native `0403`, native `1402`, and native `0801` register all returned `0x7F22`; keep `Format1 ASCII` on the practical contiguous/helper path |
