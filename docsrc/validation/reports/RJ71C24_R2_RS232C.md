...
| Setup | Scope | Result |
|---|---|---|
| `28800 / 8E2 / Format4 ASCII / CRLF / sum-check on / station 0 / --series ql / 4C` | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, `1618`, reversible remote control | pass |
| `28800 / 8E2 / Format4 ASCII / CRLF / sum-check on / station 0 / --series ql / 3C` | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, `1618`, reversible remote control | pass |
...
| `28800 / 8E2 / Format1 ASCII / sum-check on / station 0 / --series ql` | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, reversible remote control | pass |
| `28800 / 8E2 / Format2 ASCII / sum-check on / station 0 / --series ql / 4C` | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, reversible remote control, `1618` | pass |
| `28800 / 8E2 / Format2 ASCII / sum-check on / station 0 / --series ql / 3C` | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, reversible remote control, `1618` | pass |
...
| `28800 / 8E2 / Format5 Binary / sum-check on / station 0 / --series iqr` | iQ-R-only spot-device checks, `Jn\...`, native `0403/1402/0801` focused rechecks, `1617` error clear, `0610/1610`, `1615`, `1618` | pass |
...
| Remote password unlock/lock | target-dependent / unresolved | focused `--series iqr` checks returned `0x7FE7` for a `6`-character `unlock` attempt and `0x7F22` for `lock` plus longer `unlock` attempts (`10` and `32` characters); on `R08CPU` (2026-06-12), user-configured `123456melsec` returned `0x7F22` for both `unlock` and `lock`, while changed password `abcdef1` returned `0x7FE7` on `unlock`; read-only `cpu-model` and `read-words D0 1` remained available |
...
`c4-binary`, `28800 / 8E2`, `sum-check on`, `station 0`, `--series iqr`).
