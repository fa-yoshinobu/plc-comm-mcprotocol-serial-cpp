...
| User frame / serial-module control extras | pass | `0610/1610` write-read-delete and `0631` also passed on the `Format1 ASCII` setup with temporary flash user-frame `0x03E8`; missing `0x03E8` and `0x8001` reads returned `0x7E51`; `1615` remains a binary `4C Format5` action and is not part of the `Format1 ASCII` path; `1618` was validated on the focused binary recheck |
