...
| Format4 ASCII practical path (`4C` / `3C`) | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, `1618`, reversible remote control | native pass | validated on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format4 ASCII / CRLF / sum-check on / station 0 / --plc-profile melsec:q-l`; both `c4-ascii-f4` and `c3-ascii-f4` passed `probe-all 26/26`, `probe-write-all 25/25`, `probe-write-host-buffer=ok start=0`, helper `U3E0\\G0` write/read/restore, temporary user-frame `0x03E8` register/read/delete, `global-signal on/off current 0`, and `remote-pause` / `remote-stop` / `remote-run no-force no-clear`; `sum-check off` returned `0x7F24` on `4C` and `3C` |
| Format4 ASCII practical path (`2C`) | `cpu-model`, `error-clear` focused probes | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format4 ASCII / CRLF / sum-check on / station 0 / --plc-profile melsec:q-l`, `c2-ascii-f4 cpu-model` and `c2-ascii-f4 error-clear` both returned PLC error `0x0006`; raw responses were `NAK 000006 CRLF` |
| Format1 ASCII practical path | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, reversible remote control | native pass | validated on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format1 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`; `probe-all 26/26`, `probe-write-all 25/25`, `write-words D10=1 -> read-words D10 1 -> restore`, `probe-write-host-buffer=ok start=0`, `write-qualified-words U3E0\\G0 0x1234 -> read-qualified-words U3E0\\G0 1 -> restore`, temporary user-frame `0x03E8` register/read/delete, and `remote-pause` / `remote-stop` / `remote-run no-force no-clear` passed |
| Format2 ASCII practical path (`4C` / `3C`) | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, `1618`, reversible remote control | native pass | validated on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format2 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`; both `c4-ascii-f2` and `c3-ascii-f2` passed `probe-all 26/26`, `probe-write-all 25/25`, `probe-write-host-buffer=ok start=0`, helper `U3E0\\G0` read/write/restore, temporary user-frame `0x03E8` register/read/delete, `global-signal on/off current 0`, and `remote-pause` / `remote-stop` / `remote-run no-force no-clear`; block numbers `0x00` and `0x7A` were accepted on `4C` |
| Format2 ASCII practical path (`2C`) | `cpu-model`, `error-clear` focused probes | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format2 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`, `c2-ascii-f2 cpu-model` and `c2-ascii-f2 error-clear` both returned PLC error `0x0006`; the same target returned `0x0106` on `c2-ascii-f1 cpu-model`, `0x1606` on `c2-ascii-f1 error-clear`, `0x0006` on `c2-ascii-f3 cpu-model/error-clear`, and timed out on `c2-ascii-f4` |
| Format3 ASCII practical path (`4C` / `3C`) | `cpu-model`, `loopback`, device-family probes, contiguous `0401/1401`, host-buffer `0613/1613`, qualified helper, `1617`, `0610/1610`, `1618`, reversible remote control | native pass | validated on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format3 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`; both `c4-ascii-f3` and `c3-ascii-f3` passed `probe-all 26/26`, `probe-write-all 25/25`, `probe-write-host-buffer=ok start=0`, helper `U3E0\\G0` read, temporary user-frame `0x03E8` register/read/delete, `global-signal on/off current 0`, and `remote-pause` / `remote-stop` / `remote-run no-force no-clear` |
| Format3 ASCII practical path (`2C`) | `cpu-model`, `error-clear` focused probes | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format3 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`, `c2-ascii-f3 cpu-model` and `c2-ascii-f3 error-clear` both returned short `NN06` frames that now decode as PLC error `0x0006` |
| Format1 ASCII native family | native `0403`, native `1402`, native `0406/1406`, native `0801/0802` | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format1 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`, native random, multi-block, and monitor probes all returned `0x7F22` |
...
| Format2 ASCII native family (`4C` / `3C`) | native `0403`, native `1402`, native `0406/1406`, native `0801/0802` | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / 28800 / 8E2 / MC Protocol Format2 ASCII / sum-check on / station 0 / --plc-profile melsec:q-l`, native random, multi-block, and monitor probes all returned `0x7F22` |
...
| Clear error information | `1617` via `error-clear` | native pass | validated on `R120PCPU / RJ71C24-R2` under `--plc-profile melsec:iq-r`, `Format1 ASCII / --plc-profile melsec:q-l`, `Format2 ASCII (4C/3C) / --plc-profile melsec:q-l`, `Format3 ASCII (4C/3C) / --plc-profile melsec:q-l`, and `Format4 ASCII (4C/3C) / --plc-profile melsec:q-l` |
| Remote RUN/STOP/PAUSE | `1001/1002/1003` via `remote-run` / `remote-stop` / `remote-pause` | native pass | validated on `R120PCPU / RJ71C24-R2` under `--plc-profile melsec:iq-r`, `Format1 ASCII / --plc-profile melsec:q-l`, `Format2 ASCII (4C/3C) / --plc-profile melsec:q-l`, `Format3 ASCII (4C/3C) / --plc-profile melsec:q-l`, and `Format4 ASCII (4C/3C) / --plc-profile melsec:q-l`; the final `remote-run` restored the original state |
...
| Random read | native `0403` | native pass | validated under both `--plc-profile melsec:q-l` and `--plc-profile melsec:iq-r` on the current RJ71C24-R2 targets |
| Random write words | native `1402` | native pass | validated under both `--plc-profile melsec:q-l` and `--plc-profile melsec:iq-r` on the current RJ71C24-R2 targets |
| Random write bits | native `1402` | native pass | validated under both `--plc-profile melsec:q-l` and `--plc-profile melsec:iq-r` on the current RJ71C24-R2 targets |
...
| Monitor register/read | native `0801/0802` | native pass | validated under both `--plc-profile melsec:q-l` and `--plc-profile melsec:iq-r` on the current RJ71C24-R2 targets |
...
| Special-device post-control sanity | `SM`, `SD`, `RD`, `LZ`, `LCN`, `J1\\...` under `--plc-profile melsec:iq-r` | native pass | current focused read/write/restore checks pass on the validated targets, including `LZ1` native `1402` on `R08CPU` |
| User frame / serial-module extras | `0610`, `1610`, `1615`, `1618` | native pass, split by link mode | binary recheck on `R120PCPU / RJ71C24-R2 / c4-binary / --plc-profile melsec:q-l` validated `0610/1610`, `1615`, and `1618`; `Format1 ASCII`, `Format2 ASCII (4C/3C) / --plc-profile melsec:q-l`, `Format3 ASCII (4C/3C) / --plc-profile melsec:q-l`, and `Format4 ASCII (4C/3C) / --plc-profile melsec:q-l` also validated temporary flash user-frame `0x03E8` register/read/delete; `Format2/3/4 ASCII (4C/3C)` additionally validated `1618` with `global-signal on/off current 0`; missing `0x03E8` and `0x8001` reads returned `0x7E51`; `init-sequence` is not applicable on ASCII links because it requires binary `4C Format5` |
| Raw module-buffer family | raw `0601/1601` probe path | native ng / target-dependent | on `R120PCPU / RJ71C24-R2 / c4-binary / --plc-profile melsec:q-l`, `probe-module-buffer` returned `0x4043` and `probe-write-module-buffer` failed on the same `0x4043`, while helper `U3E0\\G0` read/write/restore still passed |
...
| Qualified native read/write | `read-native-qualified-words` / `write-native-qualified-words` over native extended-device access | unsupported / not applicable | native `U3E0\\G10` returned `0x7E43`; native `HG` path is not applicable under `--plc-profile melsec:q-l` |
| Random read | native `0403` | native pass | focused single/dense/sparse probes pass under `--plc-profile melsec:q-l` |
| Random write words | native `1402` | native pass | focused single/dense/sparse probes pass with restore under `--plc-profile melsec:q-l` |
| Random write bits | native `1402` | native pass | focused single/dense/sparse probes pass with restore under `--plc-profile melsec:q-l` |
| Multi-block read | native `0406` | native pass | validated on the current setup |
| Multi-block write | native `1406` | native pass | validated with restore on the current setup |
...
- Validated profile selection: use `melsec:q-l`; `melsec:iq-r` caused even contiguous `D100` / `M100` reads to fail with `0x7F22`

| Area | Command path | Current status | Notes |
|---|---|---|---|
| CPU identification | `cpu-model` | native pass | returns `L26CPU-BT`, `0x0542` |
| Contiguous read/write | `0401/1401` via `read-*` / `write-*` | native pass | supported-device screening `25/25` passed with non-low addresses under `--plc-profile melsec:q-l` |
...
| Qualified native read/write | `read-native-qualified-words` / `write-native-qualified-words` over native extended-device access | unsupported / not applicable | helper-only is the supported specification on this target; native `U3E0\\G10` returned `0x4030`; native `HG` path is not applicable under `--plc-profile melsec:q-l` |
...
- Validated profile selection: use `melsec:q-l`
...
- `RJ71C24-R2`: `1630` / `1631` currently return `0x7F22` on the focused `--plc-profile melsec:iq-r`
...
- `RJ71C24-R2`, `LJ71C24`, and `QJ71C24N` pass the practical native random / write / multi-block / monitor families under `--plc-profile melsec:q-l`
- `RJ71C24-R2` supports native `0403/1402/0801` on the validated `--plc-profile melsec:iq-r` spot-device path;
