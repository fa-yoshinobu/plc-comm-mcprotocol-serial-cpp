...
| Native qualified access | unsupported / not applicable | helper-only is the supported path; native `U3E0\\G10=0x4030`; native `HG` path is not applicable under `--plc-profile melsec:q-l` |
