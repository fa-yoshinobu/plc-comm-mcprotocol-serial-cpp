...
| 1C A-series and QnA command-family selection, including `ER/EW` and `NR/NW` paths | Manual-derived | These are command-family branches, not read/write device-support policy. MC Serial 1E is not part of the public contract. |
