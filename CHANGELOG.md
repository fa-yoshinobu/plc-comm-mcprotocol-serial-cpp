...
- CI: Normalized inherited API documentation across Doxygen versions, excluded nested Git ignore files from PlatformIO packages, and installed release tools before source-archive validation.
